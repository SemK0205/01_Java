...
public class AbstractionService {
	...
	public void ex1() {
		...
		*/
		...
		People peopleKim = new People();
		peopleKim.setAddress("동두천시");
		peopleKim.setAge(29);
		...
		System.out.println(peopleKim.getGender());
		System.out.println(peopleKim.getpNo());
		System.out.println(peopleKim.getAddress());
		System.out.println(peopleKim.getPhone());
		System.out.println(peopleKim.getAge());
