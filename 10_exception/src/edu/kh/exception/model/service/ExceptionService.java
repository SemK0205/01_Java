...
public class ExceptionService  {
	...
	// 예외는 두 종류로 구분됨
	// 1) Unchecked Exception : 선택적으로 예외 처리(ex. Runtime Exce[topm)
	// 2) Checked Exception : 필수적으로 예외 처리 (ex. ID, IOException, 나머지 .. )
	Scanner sc = new Scanner(System.in);
	public void ex1() {
		// 두 정수를 입력받아 나누기한 몫 출력
	...
	public void ex3() {
		...
		try {
			...
			e.printStackTrace(); // 위 세개를 종합적으로 확인
		} catch(InputMismatchException e) {
