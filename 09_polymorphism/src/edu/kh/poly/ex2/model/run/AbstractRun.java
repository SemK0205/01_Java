...
import edu.kh.poly.ex2.model.service.KSWCalculator;

public class AbstractRun {
	
	public static void main(String[] args) {
		
		AbstractService ab = new AbstractService();
		//ab.ex1();
		
		Calculator cal = new KSWCalculator();
		...
		// 2) 자식 클래스에 공통된 매서드를 강제 구현하라고 하기 때문에
