...
public class PolyService {
	...
	public void ex1() {
		...
		Car car2 = new Tesla();
		// Tesla 객체를 참조하는 변수의 타입이 Car(보무)이기 때문에
		...
		car2.setFuel("전기");
		car2.setWheel(4);
		// car2.setBatteryCapacity(1000000); <- 오류
		
		// car3 (부모 = 자식(Spark))
		car3.setEngine("경차엔진");
		car3.setFuel("휘발유");
		car3.setWheel(4);
		//car3.setDiscountOffer(0.5); <- 오류
	...
	public void printCar(Car temp) {
		...
		// 부모타입 참조변수 = 자식타입객체
		// -> 다형성의 업캐스팅 모양과 똑같다
		// -> temp라는 Car타입 매개변수에는 Car, Tesla, Spark의 주소가 참조돼도 된다.
	...
	public void ex2() {
		...
		System.out.println(arr[1] instanceof Tesla); // true (Tesla 객체가 맞다)
		System.out.println(arr[1] instanceof Spark); // false (Spark와 Tesla는 관계없음)
		System.out.println(arr[1] instanceof Car); 	 // true (상속관계이기 때문에)
	...
	public void ex5() {
		...
		// toString() 메서드가 우선시되어 Spark의 매서드와 바인딩
		// == 동적바인딩
